...
export default function WatchRepair() {
  ...
  return (
    <>
      <Header />
      <div className="overflow-hidden relative w-full bg-red-200 h-[60vh] lg:h-[50vh] px-8 lg:px-16 py-4 lg:py-28 bg-white flex-col justify-start items-start gap-20 inline-flex lg:my-[10%]">
