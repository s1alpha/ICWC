          ...
          <div className="grow shrink basis-0 flex-col justify-start items-start gap-6 inline-flex">
            <div className="self-stretch h-full flex-col justify-start items-start gap-6 flex">
              <div className="self-stretch h-full flex-col justify-start items-start gap-1 flex">
                ...
                <div className="self-stretch text-[#182835] text-[2.5rem] lg:text-[32px] font-bold font-['Roboto'] leading-normal">
                  Quality Assurance
                </div>
                <div className="self-stretch text-gray-800 text-[1.2rem] max-w-[400px] lg:text-base font-normal font-['Roboto'] leading-normal">
                  Our team will test and ensure the quality of your movement for
                  up to{" "}
                  <p className="font-extrabold inline text-[#182835]">
                    &nbsp;1&nbsp;
                  </p>{" "}
                  year after service
                </div>
