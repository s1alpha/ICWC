...
export default function MainHero() {
  return (
    <>
      <section className="bg-red-200 relative py-[5%] px-[5%] lg:px-[25%] w-full h-[100vh] lg:h-[70vh] overflow-hidden flex flex-col md:flex-row justify-center items-center">
